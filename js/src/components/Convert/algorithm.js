...
class DemucsAPI {
    ...
    ping() {
        return this.client.algo("danielfrg/demucs/0.2.6").pipe({ ping: "" });
    }

    health() {
        return this.client.algo("danielfrg/demucs/0.2.6").pipe({ health: "" });
    }

    load() {
        return this.client
            .algo("danielfrg/demucs/0.2.6?timeout=600")
            .pipe({ load: "" });
    }
